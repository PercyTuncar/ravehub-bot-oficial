    ...
    async execute(message, args) {
        ...
        try {
            ...
            if (user.status.stress === 0) {
                return sock.sendMessage(chatId, { text: '😌 Ya estás completamente relajado/a.' });
            }
            ...
            if (user.cooldowns.relax && now.isBefore(moment(user.cooldowns.relax))) {
                ...
                return sock.sendMessage(chatId, { text: `Necesitas descansar un poco más. Podrás volver a relajarte en ${timeLeft}.` });
            }
